...
{
    [CreateAssetMenu(menuName = "Kalkuz Systems/Buff/Buff/Soulbond Zombie", fileName = "New Soulbond Zombie", order = 0)]
    public class SoulbondZombie : Soulbond
    {
        ...
        {
            if (other is SoulbondZombie)
            {
                var oth = other as SoulbondZombie;
